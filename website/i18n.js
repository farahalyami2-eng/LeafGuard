...
const TRANSLATIONS = {
  en: {
    ...
    cart_subtotal:'Subtotal', cart_shipping:'Shipping', cart_vat:'VAT (15%)',
  ...
  zh: {
    ...
    cart_subtotal:'小计', cart_shipping:'运费', cart_vat:'增值税 (15%)',
    cart_grand_total:'总计', cart_checkout:'结账',
  ...
  ar: {
    ...
    cart_subtotal:'المجموع الفرعي', cart_shipping:'الشحن', cart_vat:'ضريبة القيمة المضافة (15%)',
